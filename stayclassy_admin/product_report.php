...
<h3 style="color:grey;font-weight: bold;"><center><u>PRODUCT REPORT</u></center></h3>
...
<form action="product_report_print.php" method="POST">
  <input type="hidden" name="from_date" value="<?php echo $from_date; ?>">
  <input type="hidden" name="to_date" value="<?php echo $to_date; ?>">
  <input type="hidden" name="search" value="<?php echo $search; ?>">
<center><button type="submit" class="btn btn-dark pl-5 pr-5 mt-5 mb-5" name="print_product">PRINT</button></center>
</form>
