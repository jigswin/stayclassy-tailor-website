        ...
        <table class="table table-bordered" id="dataTable" width="100%" cellpadding="0">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo $rows['or_date']; ?></td>
              <td><?php echo $rows['or_time']; ?></td>
              ...
              <td>
                <form action="" method="POST">
                  <input type="hidden" name="editid" value="<?php echo $rows['or_id']; ?>">
                <button type="submit" class="btn btn-success " name="editbtn">EDIT</button>
                </form>
            </td>
            <td>
              <form action="" method="POST">
                <input type="hidden" name="delete_id" value="<?php echo $rows['or_id']; ?>">
