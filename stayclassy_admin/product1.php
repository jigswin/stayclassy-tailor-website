  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h4 class="m-0 font-weight-bold text-primary text-left">Product
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" style="margin-left: 60rem">Add Product</button>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <button type="submit" class="btn btn-success " name="pattern_editbtn">EDIT</button>
                </form>
            </td>
            <td>
              <form action="code.php" method="POST">
                <input type="hidden" name="pat_delid" value="<?php echo $rows['pat_id']; ?>">
                <button type="submit" class="btn btn-danger" name="pat_del_btn">DELETE</button>
              </form>
            </td>
            </tr>
              <?php
