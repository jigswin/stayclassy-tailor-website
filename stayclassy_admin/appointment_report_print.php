...
<title>www.thestayclassy.com</title>
    ...
    <body>
<h3 style="color:grey;font-weight: bold;margin-top: 5rem;"><center><u>APPOINTMENT REPORT</u></center></h3>

<?php
if(isset($_POST['print_appoint_user'])){
...
<div class="container" style="margin-top: 5rem;margin-left: -2rem;padding: 2rem;">
  <div class="container" style="padding: 1rem;margin-right: 2rem;">
