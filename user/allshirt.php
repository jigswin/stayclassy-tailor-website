        ...
        <div class="row">
          ...
          <div class="col-md-8 col-sm-12">
            <div id="filters" class="button-group" style="font-size:2rem;">
              ...
              <a href="allshirt.php" class="btn btn-primary" data-filter=".new" style="color: blue">Shirt</a>
    ...
    <div class="featured container no-gutter">
        ...
        <div class="row posts">
              ...
              $offset=($page-1)*$limit;
                ...
                $sql12="SELECT * from product_master join category_master on product_master.cate_id=category_master.cate_id where cate_name='Shirt'";
            ...
            ?>  
              <div id="1" class="item new col-md-3 card-product" style="transition: transform 0.5s;">
                ...
                {
                 echo "<center><h1>No Product In Shirt..</h1></center>"; 
                }
            ?>
        </div>
    </div>
          ...
          <div class="col-md-12">
              ...
              if(isset($cate_id)){
                ...
                if(mysqli_num_rows($pageresult)>0){
                  ...
                  echo '<ul>';
                  if($page>1){
                      echo '<li style="margin-right:.5rem;"><a href="allshirt.php?page='.($page-1).'"><i class="fa fa-angle-left"></i></a></li>';
                  }
                  ...
                  for($i=1;$i<=$totalpages;$i++){
                    ...
                    echo '<li class="'.$active.'" style="margin-right:.5rem;"><a href="allshirt.php?page='.$i.'">'.$i.'</a></li>';
                  }
                  if($totalpages > $page){
                     echo '<li style="margin-right:.5rem;"><a href="allshirt.php?page='.($page+1).'"><i class="fa fa-angle-right"></i></a></li>';
