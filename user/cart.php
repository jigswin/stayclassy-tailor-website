...
<div class="container cart-page " >
  ...
  <table class="table-bordered">
    <tr style="background-color: #284D6B ">
      <th>Product</th>
      <th>Pattern</th>
      <th>Quntity</th>
      <th>Sub Total</th>
...
<?php
  ...
  if($totalcount==0){
    echo "<div style='margin-bottom:3rem;font-weight:20rem;font-size:3rem;'><center>Your cart is empty. Please go to the shop page.</center></div>";
  }
...
?>
    ...
    <tr>
      <td>
        <div class="cart-info">
          <?php echo '<img id="pro_img" src="../stayclassy_admin/upload/'.$pro_item['pro_image'].'" >'; ?> 
          <div>
          <div><?php echo $pro_item['pro_name']; ?></div>
          <div><i class="fa fa-inr" aria-hidden="true"></i> <?php echo $pro_item['pro_price']; ?></div>
          ...
          $sqlpattern="SELECT * FROM pattern_details,pattern_order_master1 WHERE pattern_details.pat_id=pattern_order_master1.pat_id AND pro_id='$product_id' AND u_id='$userid'";
            ...
            if(mysqli_num_rows($resultpattern)>0){
              while($patternrows=mysqli_fetch_assoc($resultpattern)){
                ...
                // echo $pat_order_id;
                ?>
          <div><?php echo '<img id="pat_img" src="../stayclassy_admin/upload/'.$patternrows['pat_img'].'">'; ?></div>
           <div><?php echo "<i class='fa fa-inr' aria-hidden='true'></i> ".$patternrows['pat_price'];?></div>
      ...
      <td>
        ...
        <span>
          ...
          <button type="submit" class="btn" name="incbtn" style="background-color: #5D5F61 ;color: white;padding-right: 1rem;padding-left:1rem;width: 4rem;"><i class='fa fa-plus' aria-hidden='true'></i></button>
        </form>
        ...
        <input type="text" value="<?php echo $cartrows['qty']; ?>" class="changeqty">
          <button type="submit" class="btn btn-danger" name="decbtn" style="background-color: #5D5F61 ;color: white;padding-right: 1rem;padding:1rem;width: 4rem;"><i class="fa fa-minus" aria-hidden="true"></i></button>
        </center>
           </form>
        </div> 
      ...
      <td>
        <form action="cart.php" method="POST">
          ...
          <button class="btn" type="submit" name="cartremove" style="border-radius: 50%;background-color:#5D5F61 ;color: white"><i class="fa fa-trash" aria-hidden="true" style="font-size: 2rem" ></i></button>
        </form>
...
?>
<tr >
  <th colspan="3" style="padding:1rem;text-align: right;background-color: lightgrey;color:black">TOTAL : </th>
  <th colspan="2" style="background-color: lightgrey;color: black"><i class='fa fa-inr' aria-hidden='true'></i> <?php echo $total;?></th>
</tr>
...
<div class="container" id="checkbtn">
  ...
  <center><button class="btn btn-primary" type="submit" name="ordersave" id="ordersave" style=" ">Proceed</button></center>
</form>
  
<center><a href="shop.php" class="btn btn-dark" id="continue" style="padding-left: 5.5rem;padding-right: 5.5rem">Continue shopping</a></center>
