...
<li><a href="shop.php" class="hovereffect">SHOP</a><i class="fa fa-plus" aria-hidden="true" onclick="opensubdrop()" id="plusbtn"></i> </li>
 ...
 -->
        <ul class="navicon">
          ...
          <li><a href="cart.php"><i class="fa fa-shopping-cart" id="cart" aria-hidden="true"></i><sup>
            ...
            ?>)</sup></a></li>
          <!-- <li id="rs"> <b>/</b> <a href="buy.php"><i class="fa fa-inr" aria-hidden="true">0.00</i></a></li> -->
