        ...
        <div class="row">
          ...
          <div class="col-md-8 col-sm-12">
            <div id="filters" class="button-group" style="font-size:2rem;">
             <a href="shop.php" class="btn btn-primary" data-filter="*">All Products</a>
              <a href="allshirt.php" class="btn btn-primary" data-filter=".new">Shirt</a>
              <a href="alltrouser.php" class="btn btn-primary" data-filter="*" style="color: blue">Trouser</a>
    ...
    <div class="featured container no-gutter">
        ...
        <div class="row posts">
              ...
              $offset=($page-1)*$limit;
                ...
                $sql12="SELECT * from product_master join category_master on product_master.cate_id=category_master.cate_id where cate_name='Trouser'";
                $result12=mysqli_query($conn,$sql12);
                if(mysqli_num_rows($result12)>0){
                  while($caterows=mysqli_fetch_assoc($result12)){
                    $cate_id=$caterows['cate_id'];
                  }
                }

                    if(isset($cate_id)){
                    $sql1="SELECT * from product_master where cate_id='$cate_id' order by pro_id desc LIMIT {$offset},{$limit}";
            ...
            {
              echo "<center><h1>No Product In Trouser..</h1></center>";
            }
            ?>
        </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
              ...
              <?php
                if(isset($cate_id)){
                $pagesql="SELECT * FROM product_master where cate_id='$cate_id'";
                ...
                if(mysqli_num_rows($pageresult)>0){
                  ...
                  echo '<ul>';
                  if($page>1){
                      echo '<li style="margin-right:.5rem;"><a href="alltrouser.php?page='.($page-1).'"><i class="fa fa-angle-left"></i></a></li>';
                  }
                  ...
                  for($i=1;$i<=$totalpages;$i++){
                    ...
                    echo '<li class="'.$active.'" style="margin-right:.5rem;"><a href="alltrouser.php?page='.$i.'">'.$i.'</a></li>';
                  }
                  if($totalpages > $page){
                     echo '<li style="margin-right:.5rem;"><a href="alltrouser.php?page='.($page+1).'"><i class="fa fa-angle-right"></i></a></li>';
