        ...
        <div class="row">
          ...
          <div class="col-md-8 col-sm-12">
            <div id="filters" class="button-group" style="font-size:2rem;">
              ...
              <a href="highprice.php" class="btn btn-primary" data-filter=".new" style="color: blue">High Price</a>
    ...
    <div class="featured container no-gutter">
        ...
        <div class="row posts">
              ...
              $offset=($page-1)*$limit;
                ...
                //   }
                // }
                    $sql1="SELECT * from product_master order by pro_price desc LIMIT {$offset},{$limit}";
          ...
          <div class="col-md-12">
              ...
              <?php
                ...
                if(mysqli_num_rows($pageresult)>0){
                  ...
                  echo '<ul>';
                  if($page>1){
                      echo '<li style="margin-right:.5rem;"><a href="highprice.php?page='.($page-1).'"><i class="fa fa-angle-left"></i></a></li>';
                  }
                  ...
                  for($i=1;$i<=$totalpages;$i++){
                    ...
                    echo '<li class="'.$active.'" style="margin-right:.5rem;"><a href="highprice.php?page='.$i.'">'.$i.'</a></li>';
                  }
                  if($totalpages > $page){
                     echo '<li style="margin-right:.5rem;"><a href="highprice.php?page='.($page+1).'"><i class="fa fa-angle-right"></i></a></li>';
